...
<!ATTLIST figure-2d %global-atts;  class CDATA "- topic/figure-2d "   >
<!ATTLIST graphic-2d %global-atts;  class CDATA "- topic/graphic-2d " >
...
<!ATTLIST extxref	%global-atts;  class CDATA "- topic/extxref "    >
