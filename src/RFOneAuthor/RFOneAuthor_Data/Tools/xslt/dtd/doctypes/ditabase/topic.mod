...
<!-- ============================================================= -->
<!--                    PARTSLIST ELEMENT INTEGRATION  (Westport customization 29 June 2012)     -->
<!-- ============================================================= -->
...
<!ENTITY % basic.block.notbl
                      "%p;|%lq;|%note;|%dl;|%ul;|%ol;|%sl;|%pre;|%lines;|%fig;|%figure-2d;|%image;|%graphic-2d; | %object;">
<!ENTITY % basic.block.nonote
                      "%p;|%lq;|       %dl;|%ul;|%ol;|%sl;|%pre;|%lines;|%fig;|%figure-2d;|%image;|%graphic-2d; | %object;|%table;|%simpletable;">
<!ENTITY % basic.block.nopara
                      "    %lq;|%note;|%dl;|%ul;|%ol;|%sl;|%pre;|%lines;|%fig;|%figure-2d;|%image;|%graphic-2d; | %object;|%table;|%simpletable;">
<!ENTITY % basic.block.nolq
                      "%p;|     %note;|%dl;|%ul;|%ol;|%sl;|%pre;|%lines;|%fig;|%figure-2d;|%image;|%graphic-2d; | %object;|%table;|%simpletable;">
...
<!ENTITY % basic.block.notbnofg2d
                      "%p;|%lq;|%note;|%dl;|%ul;|%ol;|%sl;|%pre;|%lines;|      %graphic-2d;| %object;">
<!ENTITY % basic.block.notbfgobj2d
                      "%p;|%lq;|%note;|%dl;|%ul;|%ol;|%sl;|%pre;|%lines;|      %graphic-2d;">				  
...
<!ENTITY % section.cnt          "%title;, (%basic.block;)*">
...
<!ENTITY % fig2d.cnt              "%basic.block.notbnofg2d; | %simpletable;">
...
<!ELEMENT topic         (%title;, (%titlealts;)?, (%shortdesc;)?, 
                         ...
                         (%topic-info-types;)*)                    >
			 <!-- WAS: (%topic-info-types;)*,(task)?,(animated-procedure)* -->
<!ATTLIST topic           
             id         ID                                 #IMPLIED
             conref     CDATA                              #IMPLIED
             %select-atts;
...
<!ATTLIST xref            
             ...
             outputclass 
                        CDATA                            #IMPLIED    >
<!ELEMENT extxref          (%xreftext.cnt; | %desc;)*                   >
<!ATTLIST extxref            
             href       CDATA                            #IMPLIED
             keyref     CDATA                            #IMPLIED
             type       CDATA                            #IMPLIED
